...
echo "\r\n高德地图:"
echo "\r\n查询城市区域编码:\r\n"
curl -i -H "Content-Type: application/json" -d '{"city": "北京"}' "http://localhost:8080/api/amap_district"

echo "\r\n\r\n根据区域编码获得天气数据:\r\n"
curl -i -H "Content-Type: application/json" -d '{"city": "110100"}' "http://localhost:8080/api/amap_weather"
...
echo "\r\n科大讯飞 NLP:"
echo "\r\n对输入内容进行分词:\r\n"
curl -i -X POST -d '{"content": "北京的天气"}' "http://localhost:8080/api/kdxf_nlp_cws"

echo "\r\n对输入内容标注词性:\r\n"
curl -i -X POST -d '{"content": "北京的天气"}' "http://localhost:8080/api/kdxf_nlp_pos"

echo "\r\n对输入内容提取关键词:\r\n"
curl -i -X POST -d '{"content": "北京的天气"}' "http://localhost:8080/api/kdxf_nlp_ke"
...
echo "\r\n企业微信:"
echo "\r\n获得 access_token:\r\n"
curl -i "http://localhost:8080/api/qywx_gettoken"
...
echo "\r\n查询百度图片分类token"
curl  -i "http://localhost:8080/api/baidu_image_classify_token"
